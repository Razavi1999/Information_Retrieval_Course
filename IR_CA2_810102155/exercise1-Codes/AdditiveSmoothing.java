...
//        mu = p.get("mu", 1500D);
        ...
        max = additiveScore(p.getLong("maximumCount"), p.getLong("maximumCount"));
    ...
    public double score(ScoringContext c) {
        ...
        return additiveScore(count, length);
    }

    private double additiveScore(double count, double length) {
        double numerator = count + 1;
        double denominator = length + 263375;
