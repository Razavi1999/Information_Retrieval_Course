...
public class BM25_5_ScoringIterator
    ...
    public BM25_5_ScoringIterator(NodeParameters np, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(np , ls , it);
    ...
    private double score(double count , double length) {
        double numerator = count * count;
        double denominator = count * count + (k * (1 - b + (b * length / avgDocLength)));
