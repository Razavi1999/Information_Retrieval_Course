...
public class BM25_1_ScoringIterator
    ...
    public BM25_1_ScoringIterator(NodeParameters np, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(np , ls , it);

        // statistics for BM25-version-1 scoring
        b = np.get("b", 0.75);
        k = np.get("k", 1.2);
    ...
    private double score(double maximumCount, double maximumCount1) {
        return idf;
    }
