...
public class DirichletSmoothing extends ScoringFunctionIterator
    ...
    public DirichletSmoothing(NodeParameters p, LengthsIterator ls, CountIterator it)
            throws IOException {
        super(p, ls, it);
